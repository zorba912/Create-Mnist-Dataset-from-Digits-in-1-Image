# Source code: https://github.com/Arlen0615/Convert-own-data-to-MNIST-format
# 
...
dstPath = "converted_to_MNIST"
testLabelPath = dstPath+"/my-test-100-labels-idx1-ubyte"
testImagePath = dstPath+"/my-test-100-images-idx3-ubyte"
trainLabelPath = dstPath+"/my-train-600-labels-idx1-ubyte"
trainImagePath = dstPath+"/my-train-600-images-idx3-ubyte"
